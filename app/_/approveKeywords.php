                ...
                <div class="contenttype container-coll">
                    ...
                    <div class="container-wrap">
                        ...
                        <div class="contenttype-coll container-coll">
                         ...
                         <div class="contenttype-coll container-coll">
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-17" class="contenttype__checkbox" value="Lists" <?php if(!empty($ctype)){if(in_array('Lists',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-17" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Lists</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-18" class="contenttype__checkbox" value="How-To" <?php if(!empty($ctype)){if(in_array('How-To',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-18" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">How-To</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-19" class="contenttype__checkbox" value="Questions & Answers (Q&A)" <?php if(!empty($ctype)){if(in_array('Questions & Answers (Q&A)',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-19" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Questions & Answers (Q&A)</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-20" class="contenttype__checkbox" value="Case Studies" <?php if(!empty($ctype)){if(in_array('Case Studies',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-20" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Case Studies</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-21" class="contenttype__checkbox" value="Testimonials" <?php if(!empty($ctype)){if(in_array('Testimonials',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-21" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Testimonials</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-22" class="contenttype__checkbox" value="Interviews" <?php if(!empty($ctype)){if(in_array('Interviews',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-22" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Interviews</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-23" class="contenttype__checkbox" value="Demos" <?php if(!empty($ctype)){if(in_array('Demos',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-23" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Demos</label>
                            
                            <input type="checkbox" name="contenttype[]" id="contenttype__checkbox-24" class="contenttype__checkbox" value="Product Review" <?php if(!empty($ctype)){if(in_array('Product Review',$ctype)){echo "checked";}}?>>
                            <label for="contenttype__checkbox-24" class="contenttype__checkbox-custom contenttype__checkbox-custom-text">Product Review</label>
                        </div>
                    </div>
                </div>
            </div>
