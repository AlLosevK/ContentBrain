        ...
        <div class="container-coll">
            ...
            <table class="approvetable2">
				...
				<tr class="approvetable2__body-row">
                        ...
                        <td></td>
                        <td>
                            <a href="javaScript:" data-title="<?php echo $title[0];?>" class="approvecontent2__button js-show__button-things approvecontent2__button-item">find sourses</a>
                        </td>
                </tr>
				<?php
				}	
